...
--> SELECT DISTINCT DataHistorico_d0, DataHistorico_d1 FROM Modelo.[POC_Historico].[Diferencas_agg]
-- ORDER BY DataHistorico_d1 DESC

--> SELECT DISTINCT [Data] FROM Book.Curva.Curva_FWD WHERE Curva = 'Oficial'
-- ORDER BY [Data] DESC

--> SELECT * FROM Book.Curva.Curva_Fwd_Automatica --WHERE Curva = 'Oficial'
-- ORDER BY [Data] DESC

--> gerar informaçaõ para gravar na tabela  Modelo.[POC_Historico].[Diferencas_agg]
