USE [Modelo]
GO
/****** Object:  UserDefinedFunction [dbo].[s_all_operations_portfolio]    Script Date: 05/03/2025 10:56:31 ******/
SET ANSI_NULLS ON
GO
...
ALTER function [dbo].[s_all_operations_portfolio] (
...
SELECT 
					...
					, CASE WHEN A.Thunders = 'Safira' THEN  (CASE
                              ...
                              WHEN Thunders = 'Indra' THEN  (CASE
                                                    ...
                                                    END     )
                        END as Portfolio2
				FROM dbo.s_all_operations(@dataVigencia) AS A
