...
END
	...
	SELECT 
		...
		DELETE FROM [modelo].[BaseHistorica].[BoletasProcessadas] where DataHistorico = @dataHistorico AND Thunders = 'Comercial';

		INSERT INTO [modelo].[BaseHistorica].[BoletasProcessadas]
