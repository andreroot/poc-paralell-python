...
BEGIN
    ...
    -- Teste para avaliar webhook
    --SET @anofornecimento_min=2026;
    -- teste para acionar webhook
    --SET @data_historico_d0 = (SELECT DATEADD(DAY, 0, max(DataHistorico_d1)) FROM Modelo.[POC_Historico].[Diferencas_agg] );
