...
def extract_operations(database, file):

    @stream_log_method_decorator(f'sql-server/extract_{database}_all_operations') 
    def execute():
...
if __name__=='__main__':
    ...
    tasks=[extract_operations('Book','proc_base_safira_insert_all_history.sql'),
           extract_operations('BookComercial','proc_base_comercial_insert_all_history.sql'),
           extract_operations('BookIndra','proc_base_indra_insert_all_history.sql')]       
